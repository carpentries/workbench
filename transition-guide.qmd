...
1. If you haven't already, Follow the [setup instructions for the workbench](https://carpentries.github.io/sandpaper-docs/#setup) to install R, pandoc, and the workbench packages
