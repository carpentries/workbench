...
| Expected Transition|Lesson                     |Preview                            | Tracking Issue |
|---------:|:--------------------------|:----------------------------------|:-------:|
|2023-05-15|[astronomy-python](https://datacarpentry.github.io/astronomy-python/)| [:mag: astronomy-python](https://fishtree-attempt.github.io/astronomy-python) |[#89](https://github.com/carpentries/lesson-transition/issues/89)|
